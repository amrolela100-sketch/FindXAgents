...
import { Zap, Sun, Moon, Globe, ArrowLeft, ArrowRight, FileText } from "lucide-react";
...
export default function TermsPage() {
  ...
  const sections = [
    { title: t.legal.section.acceptance,  body: t.legal.section.acceptanceText },
    { title: t.legal.section.use,         body: t.legal.section.useText },
    { title: t.legal.section.data,        body: t.legal.section.dataText },
    { title: t.legal.section.ip,          body: t.legal.section.ipText },
    { title: t.legal.section.termination, body: t.legal.section.terminationText },
