...
const PROVIDER_TYPES: ProviderConfig[] = [
  ...
  { value: "openrouter", label: "OpenRouter", icon: "🔀", color: "#7c3aed", description: "100+ models from one API", apiKeyLabel: "OpenRouter API Key", apiKeyPlaceholder: "sk-or-v1-...", apiKeyUrl: "https://openrouter.ai/keys", apiKeyUrlLabel: "openrouter.ai", defaultBaseUrl: "https://openrouter.ai/api/v1", baseUrlEditable: false, models: ["openai/gpt-4o", "anthropic/claude-3.5-sonnet", "google/gemini-2.0-flash", "meta-llama/llama-3.3-70b-instruct"], defaultModel: "google/gemini-2.0-flash", keyPrefix: "sk-or-" },
